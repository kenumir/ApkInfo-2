...
public class SaveUserInfoWork extends Worker {
    ...
    public SaveUserInfoWork(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        try {
            ...
            Log.e("apkinfo", "SaveUserInfoWork: getInstallerPackage", e);
        }
        ...
        try {
            ...
            Response response = client.newCall(new Request.Builder()
                    .url("https://fpstest.kenumir.pl/api/v2/apkinfo")
            ...
            Log.e("apkinfo", "SaveUserInfoWork: request failed", e);
        }
        return Result.retry();
    }
