...
public class SaveInstallReferrerWork extends Worker {
    ...
    public SaveInstallReferrerWork(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        String installReferrer = getInputData().getString(UserInfo.KEY_INSTALL_REFERRER);
        ...
        try {
            ...
            Log.e("apkinfo", "SaveInstallReferrerWork: getInstallerPackage", e);
        }
        ...
        try {
            ...
            json.put("uuid", uuid);
            json.put("app_version_name", appVersionName);
            json.put("install_referrer", installReferrer);
            ...
            if (BuildConfig.DEBUG) {
                Log.e("apkinfo", "SaveInstallReferrerWork: " + e, e);
            }
        }
        return Result.retry();
    }
